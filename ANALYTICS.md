...
#### Call the injectAnalytics function in your main layout
...
#### Add the inject function to your main app file
...
This project (GitHub Readme Stats) is deployed on Vercel as a serverless API that generates dynamic SVG cards. Web Analytics has been enabled to monitor:
- API endpoint usage
- Performance metrics
- Traffic patterns
...
Web Analytics is enabled through the `vercel.json` configuration:
